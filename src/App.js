                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="card" style={{width: '95%'}}>
                                ...
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Цена автотранспорта: <span>
                                    <NumberFormat
                                        className="dashboard-number-format"
                                    ...
                                    <li className="list-group-item">Первоначальный взнос UZS: <span>
                                    <NumberFormat
                                        className="dashboard-number-format"
                                    ...
                                    <li className="list-group-item">Итого выплачаемый в месяц: <span>
                                        <NumberFormat
                                            className="dashboard-number-format"
                                    ...
                                    <li className="list-group-item">Сумма кредита: <span>
                                    <NumberFormat
                                        className="dashboard-number-format"
                                        value={table.credit}
                                        displayType={"text"}
